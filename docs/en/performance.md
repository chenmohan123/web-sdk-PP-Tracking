...
Only the dated [environment](compatibility.md) is established. No real mobile-device, worst-case performance or MOT test-set accuracy claim; page frame rate is not algorithm throughput.
