...
const result: ReIdResult = { featureSpace, detections: detections.map(d => ({ ...d, embedding: [1, 0] })), runtime: { requestedBackend: 'wasm', actualBackend: 'wasm', executionMode: 'main', runtimeVersion: 'web-sdk-pp-tracking@0.2.0-rc.0', ortVersion: '1.27.0' }, timings: { decodeMs: 0, preprocessMs: 0, inferenceMs: 1, postprocessMs: 0, totalMs: 1 } };
