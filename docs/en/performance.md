...
Real-crop numerical and two-source functional evidence is available. Full temporal-sequence appearance accuracy and cost still need evaluation. Current model timings are not a performance ranking with fixed warm-up or a new cross-device claim.
