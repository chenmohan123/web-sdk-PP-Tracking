...
const types = spawnSync(process.execPath, ['node_modules/typescript/bin/tsc', '--target', 'ES2022', '--module', 'ESNext', '--moduleResolution', 'Bundler', '--strict', '--skipLibCheck', '--declaration', '--emitDeclarationOnly', '--outDir', 'dist', 'src/index.ts'], { stdio: 'inherit' });
