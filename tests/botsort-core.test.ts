...
describe('BoT-SORT 候选帧契约',()=>{
  it('平移保留ID，报告实际补偿及CPU候选身份',()=>{
    ...
    expect(result).toMatchObject({algorithm:'botsort',frameId:1,motion:{status:'estimated',applied:true},runtime:{actualBackend:'cpu',runtimeVersion:'web-sdk-pp-tracking@0.2.0-rc.0+botsort-core.1'}});
